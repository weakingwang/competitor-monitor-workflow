...
- **飞书表格自动入库**：新增更新写入飞书多维表格，便于筛选、追踪和复盘。
- **飞书机器人推送**：只有实际新增入库数量大于 0 时，才推送飞书机器人。
- **运行日志**：每次扫描都会写入运行日志，方便排查任务执行情况。
...
注意：现阶段功能仅能监控官方 changelog / release notes，不覆盖 X、B站、YouTube 等社媒数据源。
...
### 意见邮箱
若您有更好的建议or想法，欢迎将您的建议发至邮箱：wangxuxu0808@163.com。
近期我们也会继续迭代更新~
